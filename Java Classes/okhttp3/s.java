...
public final class s
{
  ...
  private s(String paramString1, String paramString2, String paramString3, @Nullable String paramString4)
  {
  ...
  @Nullable
  public static s fw(String paramString)
  {
    ...
    for (Object localObject3 = localObject1;; localObject3 = localObject2)
    {
      ...
      break label171;
      return new s(paramString, str1, str2, (String)localObject2);
    }
  }
  ...
  {
    return ((paramObject instanceof s)) && (((s)paramObject).mediaType.equals(this.mediaType));
  }
...
/* Location:              /home/qerwtr546/Documents/Vent Source/dex2jar-2.0/classes-dex2jar.jar!/okhttp3/s.class
