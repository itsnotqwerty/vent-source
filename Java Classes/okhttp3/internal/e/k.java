...
final class k
{
  ...
  private static final k dbG = new k();
  final a dbH = new a();
  ...
  private void buildTree()
  {
    ...
    {
      int k = CODES[i];
      int j = CODE_LENGTHS[i];
      a locala2 = new a(i, j);
      for (a locala1 = this.dbH; j > 8; locala1 = locala1.dbI[m])
      {
        j = (byte)(j - 8);
        m = k >>> j & 0xFF;
        if (locala1.dbI == null) {
...
/* Location:              /home/qerwtr546/Documents/Vent Source/dex2jar-2.0/classes-dex2jar.jar!/okhttp3/internal/e/k.class
