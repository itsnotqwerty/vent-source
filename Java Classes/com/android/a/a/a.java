    ...
    implements a
  {
      ...
      implements a
    {
        ...
        throws RemoteException
      {
        ...
        //   42: aload_0
        //   43: getfield 18	com/android/a/a/a$a$a:Cw	Landroid/os/IBinder;
        //   46: iconst_4
        //   47: aload 5
        //   49: aload 6
        //   51: iconst_0
        ...
        //   68: ifeq +29 -> 97
        //   71: getstatic 69	android/os/Bundle:CREATOR	Landroid/os/Parcelable$Creator;
        //   74: aload 6
        //   76: invokeinterface 75 2 0
        //   81: checkcast 61	android/os/Bundle
        //   84: astore_2
        //   85: aload 6
        ...
        throws RemoteException
      {
        ...
        //   49: aload_0
        //   50: getfield 18	com/android/a/a/a$a$a:Cw	Landroid/os/IBinder;
        //   53: iconst_3
        //   54: aload 6
        //   56: aload 7
        //   58: iconst_0
        ...
        //   70: aload 7
        //   72: invokevirtual 54	android/os/Parcel:readInt	()I
        //   75: ifeq +29 -> 104
        //   78: getstatic 69	android/os/Bundle:CREATOR	Landroid/os/Parcelable$Creator;
        //   81: aload 7
        //   83: invokeinterface 75 2 0
        //   88: checkcast 61	android/os/Bundle
        //   91: astore_2
        //   92: aload 7
        ...
        //   115: aload 6
        //   117: invokevirtual 57	android/os/Parcel:recycle	()V
        //   120: aload_2
        //   121: athrow
        // Local variable table:
        //   start	length	slot	name	signature
      ...
      /* Error */
      public final Bundle a(int paramInt, String paramString1, List<String> paramList, String paramString2, String paramString3, String paramString4)
        throws RemoteException
      {
        // Byte code:
        //   0: invokestatic 28	android/os/Parcel:obtain	()Landroid/os/Parcel;
        ...
        //   56: aload_0
        //   57: getfield 18	com/android/a/a/a$a$a:Cw	Landroid/os/IBinder;
        //   60: bipush 7
        //   62: aload 7
        //   64: aload 8
        //   66: iconst_0
        ...
        //   78: aload 8
        //   80: invokevirtual 54	android/os/Parcel:readInt	()I
        //   83: ifeq +29 -> 112
        //   86: getstatic 69	android/os/Bundle:CREATOR	Landroid/os/Parcelable$Creator;
        //   89: aload 8
        //   91: invokeinterface 75 2 0
        //   96: checkcast 61	android/os/Bundle
        //   99: astore_2
        //   100: aload 8
...
/* Location:              /home/qerwtr546/Documents/Vent Source/dex2jar-2.0/classes-dex2jar.jar!/com/android/a/a/a.class
