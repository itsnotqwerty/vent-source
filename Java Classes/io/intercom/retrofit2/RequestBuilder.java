...
import io.intercom.okhttp3.HttpUrl.Builder;
    ...
    for (;;)
    {
      ...
      if (i < j)
      {
        ...
        if ((k < 32) || (k >= 127) || (" \"<>^`{}|\\?#".indexOf(k) != -1) || ((!paramBoolean) && ((k == 47) || (k == 37))))
        {
          ...
          canonicalizeForPath((c)localObject, paramString, i, j, paramBoolean);
      ...
      else
      {
        if ((i < 32) || (i >= 127) || (" \"<>^`{}|\\?#".indexOf(i) != -1) || ((!paramBoolean) && ((i == 47) || (i == 37))))
        {
          ...
          for (;;)
          {
            ...
            if (((c)localObject2).Kr()) {
              break;
            }
            int j = ((c)localObject2).readByte() & 0xFF;
            paramc.fv(37);
            paramc.fv(HEX_DIGITS[(j >> 4 & 0xF)]);
            paramc.fv(HEX_DIGITS[(j & 0xF)]);
          }
        }
        paramc.fu(i);
        localObject3 = localObject1;
...
/* Location:              /home/qerwtr546/Documents/Vent Source/dex2jar-2.0/classes-dex2jar.jar!/io/intercom/retrofit2/RequestBuilder.class
