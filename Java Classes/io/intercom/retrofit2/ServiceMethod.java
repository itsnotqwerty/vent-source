...
final class ServiceMethod<R, T>
{
  ...
  private final io.intercom.okhttp3.Headers headers;
  ...
  static final class Builder<T, R>
  {
    ...
    boolean gotUrl;
    boolean hasBody;
    io.intercom.okhttp3.Headers headers;
    String httpMethod;
    ...
    private io.intercom.okhttp3.Headers parseHeaders(String[] paramArrayOfString)
    {
    ...
    private void parseMethodAnnotation(Annotation paramAnnotation)
    {
      ...
      do
      {
        ...
        if ((paramAnnotation instanceof io.intercom.retrofit2.http.Headers))
        {
          paramAnnotation = ((io.intercom.retrofit2.http.Headers)paramAnnotation).value();
    ...
    private ParameterHandler<?> parseParameterAnnotation(int paramInt, Type paramType, Annotation[] paramArrayOfAnnotation, Annotation paramAnnotation)
    {
      ...
      if ((paramAnnotation instanceof Part))
      {
        ...
        localObject = io.intercom.okhttp3.Headers.of(new String[] { "Content-Disposition", "form-data; name=\"" + str + "\"", "Content-Transfer-Encoding", ((Part)localObject).encoding() });
        if (Iterable.class.isAssignableFrom(paramAnnotation))
        {
          if (!(paramType instanceof ParameterizedType)) {
            throw parameterError(paramInt, paramAnnotation.getSimpleName() + " must include generic type (e.g., " + paramAnnotation.getSimpleName() + "<String>)", new Object[0]);
          ...
          return new ParameterHandler.Part((io.intercom.okhttp3.Headers)localObject, this.retrofit.requestBodyConverter(paramType, paramArrayOfAnnotation, this.methodAnnotations)).iterable();
        }
        if (paramAnnotation.isArray())
        {
          paramType = ServiceMethod.boxIfPrimitive(paramAnnotation.getComponentType());
          ...
          return new ParameterHandler.Part((io.intercom.okhttp3.Headers)localObject, this.retrofit.requestBodyConverter(paramType, paramArrayOfAnnotation, this.methodAnnotations)).array();
        }
        if (MultipartBody.Part.class.isAssignableFrom(paramAnnotation)) {
          throw parameterError(paramInt, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
        }
        return new ParameterHandler.Part((io.intercom.okhttp3.Headers)localObject, this.retrofit.requestBodyConverter(paramType, paramArrayOfAnnotation, this.methodAnnotations));
      }
    ...
    public final ServiceMethod build()
    {
      ...
      if ((this.responseType == Response.class) || (this.responseType == io.intercom.okhttp3.Response.class)) {
...
/* Location:              /home/qerwtr546/Documents/Vent Source/dex2jar-2.0/classes-dex2jar.jar!/io/intercom/retrofit2/ServiceMethod.class
