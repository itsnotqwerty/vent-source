...
public final class CertificatePinner
{
  ...
  public static String pin(Certificate paramCertificate)
  {
    ...
    return "sha256/" + sha256((X509Certificate)paramCertificate).KF();
  }
  
  static f sha1(X509Certificate paramX509Certificate)
  {
    return f.H(paramX509Certificate.getPublicKey().getEncoded()).KH();
  }
  
  static f sha256(X509Certificate paramX509Certificate)
  {
    return f.H(paramX509Certificate.getPublicKey().getEncoded()).KI();
  }
  ...
  static final class Pin
  {
    ...
    Pin(String paramString1, String paramString2)
    {
      ...
      if (paramString1.startsWith("*."))
      {
        ...
        this.hash = f.fj(paramString2.substring(5));
      }
      for (;;)
      {
        if (this.hash == null)
        {
          ...
          if (paramString2.startsWith("sha256/"))
          {
            ...
            this.hash = f.fj(paramString2.substring(7));
          }
          else
          {
    ...
    {
      return this.hashAlgorithm + this.hash.KF();
    }
  }
}


/* Location:              /home/qerwtr546/Documents/Vent Source/dex2jar-2.0/classes-dex2jar.jar!/io/intercom/okhttp3/CertificatePinner.class
