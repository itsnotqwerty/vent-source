  ...
  implements Closeable, Flushable
{
      ...
      catch (IOException localIOException1)
      {
        ...
        catch (IOException localIOException2)
        {
          for (;;)
          {
            ...
            DiskLruCache.this.journalWriter = l.b(l.KM());
          }
        }
      }
    }
  ...
  {
    l.b(new FaultHidingSink(this.fileSystem.appendingSink(this.journalFile))
    {
      static
      {
        if (!DiskLruCache.class.desiredAssertionStatus()) {}
  ...
  private void readJournal()
    throws IOException
  {
    e locale = l.b(this.fileSystem.source(this.journalFile));
    label238:
    try
    {
      String str1 = locale.Kz();
      String str2 = locale.Kz();
      String str3 = locale.Kz();
      String str4 = locale.Kz();
      String str5 = locale.Kz();
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if ((localEntry.readable | paramBoolean))
        {
          ...
          this.journalWriter.fg("CLEAN").fB(32);
          this.journalWriter.fg(localEntry.key);
          localEntry.writeLengths(this.journalWriter);
          this.journalWriter.fB(10);
          if (paramBoolean)
          {
        ...
        for (;;)
        {
          ...
          this.journalWriter.fg("REMOVE").fB(32);
          this.journalWriter.fg(localEntry.key);
          this.journalWriter.fB(10);
        }
      }
    ...
    throws IOException
  {
    for (;;)
    {
      try
      {
        ...
        {
          this.journalWriter.fg("DIRTY").fB(32).fg(paramString).fB(10);
          this.journalWriter.flush();
    ...
    throws IOException
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 393	io/intercom/okhttp3/internal/cache/DiskLruCache:initialized	Z
    //   6: istore_1
    //   7: iload_1
    //   8: ifne +6 -> 14
    //   11: aload_0
    ...
    //   13: return
    //   14: aload_0
    //   15: invokespecial 484	io/intercom/okhttp3/internal/cache/DiskLruCache:checkNotClosed	()V
    //   18: aload_0
    //   19: invokevirtual 407	io/intercom/okhttp3/internal/cache/DiskLruCache:trimToSize	()V
    //   22: aload_0
    //   23: getfield 328	io/intercom/okhttp3/internal/cache/DiskLruCache:journalWriter	Lio/intercom/b/d;
    ...
    throws IOException
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: invokevirtual 482	io/intercom/okhttp3/internal/cache/DiskLruCache:initialize	()V
    //   6: aload_0
    //   7: invokespecial 484	io/intercom/okhttp3/internal/cache/DiskLruCache:checkNotClosed	()V
    //   10: aload_0
    //   11: aload_1
    //   12: invokespecial 486	io/intercom/okhttp3/internal/cache/DiskLruCache:validateKey	(Ljava/lang/String;)V
    //   15: aload_0
    //   16: getfield 120	io/intercom/okhttp3/internal/cache/DiskLruCache:lruEntries	Ljava/util/LinkedHashMap;
    //   19: aload_1
    //   20: invokevirtual 353	java/util/LinkedHashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   23: checkcast 21	io/intercom/okhttp3/internal/cache/DiskLruCache$Entry
    //   26: astore_3
    //   27: aload_3
    //   28: ifnull +12 -> 40
    //   31: aload_3
    //   32: getfield 369	io/intercom/okhttp3/internal/cache/DiskLruCache$Entry:readable	Z
    //   35: istore_2
    //   36: iload_2
    //   37: ifne +9 -> 46
    //   40: aconst_null
    ...
    //   45: areturn
    //   46: aload_3
    //   47: invokevirtual 502	io/intercom/okhttp3/internal/cache/DiskLruCache$Entry:snapshot	()Lio/intercom/okhttp3/internal/cache/DiskLruCache$Snapshot;
    //   50: astore_3
    //   51: aload_3
    //   52: ifnonnull +8 -> 60
    //   55: aconst_null
    ...
    //   60: aload_0
    //   61: aload_0
    //   62: getfield 318	io/intercom/okhttp3/internal/cache/DiskLruCache:redundantOpCount	I
    //   65: iconst_1
    //   66: iadd
    //   67: putfield 318	io/intercom/okhttp3/internal/cache/DiskLruCache:redundantOpCount	I
    //   70: aload_0
    //   71: getfield 328	io/intercom/okhttp3/internal/cache/DiskLruCache:journalWriter	Lio/intercom/b/d;
    //   74: ldc 52
    ...
    //   103: astore_1
    //   104: aload_0
    //   105: invokevirtual 462	io/intercom/okhttp3/internal/cache/DiskLruCache:journalRebuildRequired	()Z
    //   108: ifeq -66 -> 42
    //   111: aload_0
    //   112: getfield 150	io/intercom/okhttp3/internal/cache/DiskLruCache:executor	Ljava/util/concurrent/Executor;
    //   115: aload_0
    //   116: getfield 127	io/intercom/okhttp3/internal/cache/DiskLruCache:cleanupRunnable	Ljava/lang/Runnable;
    ...
    throws IOException
  {
    ...
    //   0: aload_0
    //   1: monitorenter
    //   2: getstatic 95	io/intercom/okhttp3/internal/cache/DiskLruCache:$assertionsDisabled	Z
    //   5: ifne +23 -> 28
    //   8: aload_0
    ...
    //   27: athrow
    //   28: aload_0
    //   29: getfield 393	io/intercom/okhttp3/internal/cache/DiskLruCache:initialized	Z
    //   32: istore_1
    //   33: iload_1
    //   34: ifeq +6 -> 40
    //   37: aload_0
    ...
    //   39: return
    //   40: aload_0
    //   41: getfield 129	io/intercom/okhttp3/internal/cache/DiskLruCache:fileSystem	Lio/intercom/okhttp3/internal/io/FileSystem;
    //   44: aload_0
    //   45: getfield 144	io/intercom/okhttp3/internal/cache/DiskLruCache:journalFileBackup	Ljava/io/File;
    //   48: invokeinterface 431 2 0
    //   53: ifeq +32 -> 85
    //   56: aload_0
    //   57: getfield 129	io/intercom/okhttp3/internal/cache/DiskLruCache:fileSystem	Lio/intercom/okhttp3/internal/io/FileSystem;
    //   60: aload_0
    //   61: getfield 140	io/intercom/okhttp3/internal/cache/DiskLruCache:journalFile	Ljava/io/File;
    //   64: invokeinterface 431 2 0
    //   69: ifeq +119 -> 188
    //   72: aload_0
    //   73: getfield 129	io/intercom/okhttp3/internal/cache/DiskLruCache:fileSystem	Lio/intercom/okhttp3/internal/io/FileSystem;
    //   76: aload_0
    //   77: getfield 144	io/intercom/okhttp3/internal/cache/DiskLruCache:journalFileBackup	Ljava/io/File;
    //   80: invokeinterface 223 2 0
    //   85: aload_0
    //   86: getfield 129	io/intercom/okhttp3/internal/cache/DiskLruCache:fileSystem	Lio/intercom/okhttp3/internal/io/FileSystem;
    //   89: aload_0
    //   90: getfield 140	io/intercom/okhttp3/internal/cache/DiskLruCache:journalFile	Ljava/io/File;
    //   93: invokeinterface 431 2 0
    //   98: istore_1
    //   99: iload_1
    //   100: ifeq +76 -> 176
    //   103: aload_0
    //   104: invokespecial 516	io/intercom/okhttp3/internal/cache/DiskLruCache:readJournal	()V
    //   107: aload_0
    //   108: invokespecial 518	io/intercom/okhttp3/internal/cache/DiskLruCache:processJournal	()V
    //   111: aload_0
    //   112: iconst_1
    //   113: putfield 393	io/intercom/okhttp3/internal/cache/DiskLruCache:initialized	Z
    //   116: goto -79 -> 37
    //   119: astore_2
    //   120: invokestatic 523	io/intercom/okhttp3/internal/platform/Platform:get	()Lio/intercom/okhttp3/internal/platform/Platform;
    //   123: iconst_5
    ...
    //   134: aload_0
    //   135: getfield 131	io/intercom/okhttp3/internal/cache/DiskLruCache:directory	Ljava/io/File;
    ...
    //   163: aload_2
    //   164: invokevirtual 539	io/intercom/okhttp3/internal/platform/Platform:log	(ILjava/lang/String;Ljava/lang/Throwable;)V
    //   167: aload_0
    //   168: invokevirtual 541	io/intercom/okhttp3/internal/cache/DiskLruCache:delete	()V
    //   171: aload_0
    //   172: iconst_0
    //   173: putfield 395	io/intercom/okhttp3/internal/cache/DiskLruCache:closed	Z
    //   176: aload_0
    //   177: invokevirtual 324	io/intercom/okhttp3/internal/cache/DiskLruCache:rebuildJournal	()V
    //   180: aload_0
    //   181: iconst_1
    //   182: putfield 393	io/intercom/okhttp3/internal/cache/DiskLruCache:initialized	Z
    //   185: goto -148 -> 37
    //   188: aload_0
    //   189: getfield 129	io/intercom/okhttp3/internal/cache/DiskLruCache:fileSystem	Lio/intercom/okhttp3/internal/io/FileSystem;
    //   192: aload_0
    //   193: getfield 144	io/intercom/okhttp3/internal/cache/DiskLruCache:journalFileBackup	Ljava/io/File;
    //   196: aload_0
    //   197: getfield 140	io/intercom/okhttp3/internal/cache/DiskLruCache:journalFile	Ljava/io/File;
    //   200: invokeinterface 435 3 0
    //   205: goto -120 -> 85
    //   208: astore_2
    //   209: aload_0
    //   210: iconst_0
    //   211: putfield 395	io/intercom/okhttp3/internal/cache/DiskLruCache:closed	Z
    //   214: aload_2
    //   215: athrow
    // Local variable table:
    //   start	length	slot	name	signature
    ...
    throws IOException
  {
    for (;;)
    {
      ...
      try
      {
        ...
        d locald1 = l.b(this.fileSystem.sink(this.journalFileTmp));
        try
        {
          locald1.fg("libcore.io.DiskLruCache").fB(10);
          locald1.fg("1").fB(10);
          locald1.am(this.appVersion).fB(10);
          locald1.am(this.valueCount).fB(10);
          locald1.fB(10);
          Iterator localIterator = this.lruEntries.values().iterator();
          ...
          if (localEntry.currentEditor != null)
          {
            locald1.fg("DIRTY").fB(32);
            locald1.fg(localEntry.key);
            locald1.fB(10);
            continue;
            locald2 = finally;
          }
        ...
        locald2.fg("CLEAN").fB(32);
      }
      finally {}
      locald2.fg(localEntry.key);
      localEntry.writeLengths(locald2);
      locald2.fB(10);
    }
    locald2.close();
    ...
    throws IOException
  {
    ...
    //   37: aload_0
    //   38: aload_1
    //   39: invokevirtual 497	io/intercom/okhttp3/internal/cache/DiskLruCache:removeEntry	(Lio/intercom/okhttp3/internal/cache/DiskLruCache$Entry;)Z
    //   42: istore_3
    //   43: iload_3
    //   44: istore_2
    //   45: iload_3
    ...
    //   50: istore_2
    //   51: aload_0
    //   52: getfield 112	io/intercom/okhttp3/internal/cache/DiskLruCache:size	J
    //   55: aload_0
    //   56: getfield 148	io/intercom/okhttp3/internal/cache/DiskLruCache:maxSize	J
    //   59: lcmp
    //   60: ifgt -27 -> 33
    //   63: aload_0
    //   64: iconst_0
    //   65: putfield 488	io/intercom/okhttp3/internal/cache/DiskLruCache:mostRecentTrimFailed	Z
    //   68: iload_3
    //   69: istore_2
    //   70: goto -37 -> 33
    //   73: astore_1
    ...
    throws IOException
  {
    ...
    this.redundantOpCount += 1;
    this.journalWriter.fg("REMOVE").fB(32).fg(paramEntry.key).fB(10);
  ...
  public final class Editor
  {
    ...
    public final s newSource(int paramInt)
    {
      ...
      try
      {
        s locals = DiskLruCache.this.fileSystem.source(this.entry.cleanFiles[paramInt]);
        return locals;
      }
      catch (FileNotFoundException localFileNotFoundException) {}
      return null;
  ...
  private final class Entry
  {
    ...
    final DiskLruCache.Snapshot snapshot()
    {
      ...
      for (;;)
      {
        try
        {
          if (i < DiskLruCache.this.valueCount)
          {
            arrayOfs[i] = DiskLruCache.this.fileSystem.source(this.cleanFiles[i]);
            i += 1;
            continue;
          }
        ...
        if ((i >= DiskLruCache.this.valueCount) || (arrayOfs[i] == null)) {
          continue;
        }
    ...
    final void writeLengths(d paramd)
      throws IOException
    {
...
/* Location:              /home/qerwtr546/Documents/Vent Source/dex2jar-2.0/classes-dex2jar.jar!/io/intercom/okhttp3/internal/cache/DiskLruCache.class
