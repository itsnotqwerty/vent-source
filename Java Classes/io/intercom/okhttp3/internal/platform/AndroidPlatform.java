  ...
  static final class CloseGuard
  {
    ...
    static CloseGuard get()
    {
      try
      {
        ...
        localMethod2 = ((Class)localObject2).getMethod("get", new Class[0]);
        Method localMethod1 = ((Class)localObject2).getMethod("open", new Class[] { String.class });
        localObject2 = ((Class)localObject2).getMethod("warnIfOpen", new Class[0]);
        return new CloseGuard(localMethod2, localMethod1, (Method)localObject2);
      }
      catch (Exception localException)
      {
        for (;;)
...
/* Location:              /home/qerwtr546/Documents/Vent Source/dex2jar-2.0/classes-dex2jar.jar!/io/intercom/okhttp3/internal/platform/AndroidPlatform.class
