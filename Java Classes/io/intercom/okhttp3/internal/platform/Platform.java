...
public class Platform
{
  ...
  static byte[] concatLengthPrefixed(List<Protocol> paramList)
  {
    ...
    while (i < j)
    {
      ...
      if (localProtocol != Protocol.HTTP_1_0)
      {
        localc.fv(localProtocol.toString().length());
        localc.ff(localProtocol.toString());
      }
      i += 1;
    }
    return localc.KA();
...
/* Location:              /home/qerwtr546/Documents/Vent Source/dex2jar-2.0/classes-dex2jar.jar!/io/intercom/okhttp3/internal/platform/Platform.class
