...
public final class Cookie
{
  ...
  static Cookie parse(long paramLong, HttpUrl paramHttpUrl, String paramString)
  {
    ...
    if (i < j)
    {
      ...
      if (m < k)
      {
        localObject2 = Util.trimSubstring(paramString, m + 1, k);
        label182:
    ...
    for (;;)
    {
      ...
      try
      {
        l4 = parseExpires((String)localObject2, 0, ((String)localObject2).length());
        bool1 = true;
      ...
      else
      {
        ...
        if (str3.equalsIgnoreCase("domain"))
        {
          try
          {
            localObject7 = parseDomain((String)localObject4);
            bool8 = false;
            l3 = l2;
            l4 = l1;
            localObject4 = localObject1;
        ...
        else
        {
          ...
          if (!str3.equalsIgnoreCase("path")) {
            ...
            else if (str3.equalsIgnoreCase("httponly"))
            {
              ...
              {
                l1 = Long.MIN_VALUE;
                localObject5 = paramHttpUrl.host();
                if (localObject6 != null) {
                  break label731;
                }
              }
              for (paramString = (String)localObject5;; paramString = (String)localObject6)
              {
                if ((((String)localObject5).length() != paramString.length()) && (PublicSuffixDatabase.get().getEffectiveTldPlusOne(paramString) == null))
                {
                  return null;
                  if (l2 == -1L) {
                    break;
                  ...
                  label731:
                  if (domainMatch((String)localObject5, (String)localObject6)) {
                    continue;
                  }
                  return null;
                }
                ...
                for (paramHttpUrl = paramHttpUrl.substring(0, i);; paramHttpUrl = "/")
                {
                  ...
                  return new Cookie(str1, str2, l1, paramString, (String)localObject5, bool5, bool4, bool2, bool3);
                }
              }
            }
            else
...
/* Location:              /home/qerwtr546/Documents/Vent Source/dex2jar-2.0/classes-dex2jar.jar!/io/intercom/okhttp3/Cookie.class
