...
public final class e
{
    ...
    throws Resources.NotFoundException
  {
    ...
    //   9: aload_1
    //   10: iload_3
    //   11: invokevirtual 23	android/content/res/Resources:getAnimation	(I)Landroid/content/res/XmlResourceParser;
    //   14: astore 7
    //   16: aload 7
    //   18: astore 5
    //   20: aload 7
    ...
    //   31: aload 7
    //   33: aload 7
    //   35: invokestatic 29	android/util/Xml:asAttributeSet	(Lorg/xmlpull/v1/XmlPullParser;)Landroid/util/AttributeSet;
    //   38: aconst_null
    //   39: iconst_0
    //   40: fconst_1
    //   41: invokestatic 32	android/support/c/a/e:a	(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/animation/AnimatorSet;IF)Landroid/animation/Animator;
    //   44: astore_0
    //   45: aload 7
    //   47: ifnull +10 -> 57
    //   50: aload 7
    ...
    //   60: aload 5
    //   62: astore 4
    //   64: new 13	android/content/res/Resources$NotFoundException
    //   67: dup
    ...
    //   110: ifnull +10 -> 120
    //   113: aload 4
    //   115: invokeinterface 38 1 0
    //   120: aload_0
    //   121: athrow
    //   122: astore_0
    //   123: aload 6
    //   125: astore 4
    //   127: new 13	android/content/res/Resources$NotFoundException
    //   130: dup
    ...
    throws XmlPullParserException, IOException
  {
    ...
    for (;;)
    {
      ...
      if (((String)localObject1).equals("set"))
      {
        ...
        localObject2 = c.a(paramResources, paramTheme, paramAttributeSet, a.qs);
  ...
  private static PropertyValuesHolder a(TypedArray paramTypedArray, int paramInt1, int paramInt2, int paramInt3, String paramString)
  {
    ...
    for (;;)
    {
      if (i == 2)
      {
        ...
        b.b[] arrayOfb1 = b.y((String)localObject);
        b.b[] arrayOfb2 = b.y(paramTypedArray);
  ...
  private static ValueAnimator a(Context paramContext, Resources paramResources, Resources.Theme paramTheme, AttributeSet paramAttributeSet, ValueAnimator paramValueAnimator, float paramFloat, XmlPullParser paramXmlPullParser)
    throws Resources.NotFoundException
  {
    TypedArray localTypedArray = c.a(paramResources, paramTheme, paramAttributeSet, a.qr);
    paramTheme = c.a(paramResources, paramTheme, paramAttributeSet, a.qv);
  ...
  private static void a(ValueAnimator paramValueAnimator, TypedArray paramTypedArray1, TypedArray paramTypedArray2, float paramFloat, XmlPullParser paramXmlPullParser)
  {
    ...
    label354:
    a(b.x(paramTypedArray1), paramValueAnimator, 0.5F * paramFloat, (String)localObject, paramXmlPullParser);
    label371:
    return;
    label372:
    ...
    throws XmlPullParserException, IOException
  {
    ...
    {
      TypedArray localTypedArray1 = c.a(paramResources, paramTheme, paramAttributeSet, a.qt);
      ...
      if ((j != 3) && (j != 1))
      {
        ...
        if (paramXmlPullParser.getName().equals("keyframe"))
        {
          ...
          if (i == 4)
          {
            localObject2 = c.a(paramResources, paramTheme, Xml.asAttributeSet(paramXmlPullParser), a.qu);
            localObject3 = c.a((TypedArray)localObject2, paramXmlPullParser, "value");
            if (localObject3 == null) {
              break label418;
            }
            i = 1;
            if ((i == 0) || (!T(((TypedValue)localObject3).type))) {
              break label424;
            }
            i = 3;
            ((TypedArray)localObject2).recycle();
          ...
          localTypedArray2 = c.a(paramResources, paramTheme, Xml.asAttributeSet(paramXmlPullParser), a.qu);
          localObject3 = null;
          ...
          if ((k == 0) || (!T(((TypedValue)localObject2).type))) {
            break label436;
          }
          i = 3;
          label287:
        ...
        for (;;)
        {
          i = c.a(localTypedArray2, paramXmlPullParser, "interpolator", 1);
          if (i > 0) {
      ...
      else if (localObject1 != null)
      {
        ...
        if (j > 0)
        {
          ...
          if (f < 1.0F)
          {
            ...
            if (i == 3)
            {
              ((PropertyValuesHolder)localObject2).setEvaluator(f.ce());
              localObject1 = localObject2;
            }
            label848:
            if (localObject1 == null)
...
/* Location:              /home/qerwtr546/Documents/Vent Source/dex2jar-2.0/classes-dex2jar.jar!/android/support/c/a/e.class
