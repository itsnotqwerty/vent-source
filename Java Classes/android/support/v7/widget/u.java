...
class u
{
  private static final int[] RE = { 16843067, 16843068 };
  private final ProgressBar Wp;
  Bitmap Wq;
  
  u(ProgressBar paramProgressBar)
  {
    this.Wp = paramProgressBar;
  }
  ...
  private Drawable b(Drawable paramDrawable, boolean paramBoolean)
  {
    ...
    if ((paramDrawable instanceof c))
    {
      ...
      if (localObject1 != null)
      {
        ...
        ((c)paramDrawable).h((Drawable)localObject1);
      }
    }
    do
    {
  ...
  {
    bo localbo = bo.a(this.Wp.getContext(), paramAttributeSet, RE, paramInt, 0);
    Object localObject = localbo.ch(0);
    if (localObject != null)
    {
      ProgressBar localProgressBar = this.Wp;
    ...
    paramAttributeSet = localbo.ch(1);
    if (paramAttributeSet != null) {
      this.Wp.setProgressDrawable(b(paramAttributeSet, false));
    }
    localbo.ajT.recycle();
  }
}
...
/* Location:              /home/qerwtr546/Documents/Vent Source/dex2jar-2.0/classes-dex2jar.jar!/android/support/v7/widget/u.class
