  ...
  extends LinearLayout
{
  ...
  public ButtonBarLayout(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.Xj = paramContext.getBoolean(a.j.ButtonBarLayout_allowStacking, true);
  ...
  {
    return Math.max(this.Xl, super.getMinimumHeight());
  }
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    int j;
    if ((!gs()) && (View.MeasureSpec.getMode(paramInt1) == 1073741824))
    {
  ...
  {
    if (this.Xj != paramBoolean)
    {
      this.Xj = paramBoolean;
      if ((!this.Xj) && (getOrientation() == 1)) {
        setStacked(false);
      }
      requestLayout();
    }
...
/* Location:              /home/qerwtr546/Documents/Vent Source/dex2jar-2.0/classes-dex2jar.jar!/android/support/v7/widget/ButtonBarLayout.class
