...
final class o
{
  ...
  public final void a(long paramLong, double paramDouble1, double paramDouble2)
  {
    ...
    this.Ov = (Math.round((f1 + paramDouble2) * 8.64E7D) + 946728000000L);
    this.Ow = (Math.round((paramDouble2 - f1) * 8.64E7D) + 946728000000L);
    if ((this.Ow < paramLong) && (this.Ov > paramLong))
    {
      this.state = 0;
      return;
    }
...
/* Location:              /home/qerwtr546/Documents/Vent Source/dex2jar-2.0/classes-dex2jar.jar!/android/support/v7/app/o.class
