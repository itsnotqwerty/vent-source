...
public final class c
{
  HandlerThread DG;
  private int DH;
  private Handler.Callback DI = new Handler.Callback()
  {
    public final boolean handleMessage(Message arg1)
    {
      ...
      case 1: 
        ...
        synchronized (localc1.mLock)
        {
          ...
          localc1.mHandler.sendMessageDelayed(localc1.mHandler.obtainMessage(0), localc1.DJ);
          return true;
        }
      }
      c localc2 = c.this;
      ...
      ((c)localObject2).DG.quit();
      ((c)localObject2).DG = null;
      ((c)localObject2).mHandler = null;
      return true;
    }
  };
  final int DJ;
    ...
    throws java.lang.InterruptedException
  {
    ...
    //   33: astore 10
    //   35: aload_0
    //   36: new 12	android/support/v4/e/c$3
    //   39: dup
    //   40: aload_0
    //   41: aload 9
    //   43: aload_1
    ...
    //   46: aload 10
    //   48: aload 8
    //   50: invokespecial 71	android/support/v4/e/c$3:<init>	(Landroid/support/v4/e/c;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/Callable;Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Ljava/util/concurrent/locks/Condition;)V
    //   53: invokevirtual 75	android/support/v4/e/c:g	(Ljava/lang/Runnable;)V
    //   56: aload 7
  ...
  final void g(Runnable paramRunnable)
  {
    synchronized (this.mLock)
    {
      if (this.DG == null)
      {
        this.DG = new HandlerThread(this.DK, this.zD);
        this.DG.start();
        this.mHandler = new Handler(this.DG.getLooper(), this.DI);
        this.DH += 1;
      }
...
/* Location:              /home/qerwtr546/Documents/Vent Source/dex2jar-2.0/classes-dex2jar.jar!/android/support/v4/e/c.class
