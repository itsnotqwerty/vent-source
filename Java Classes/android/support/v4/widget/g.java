  ...
  extends Filter
{
  ...
  {
    return this.Jj.convertToString((Cursor)paramObject);
  }
  
  protected final Filter.FilterResults performFiltering(CharSequence paramCharSequence)
  {
    paramCharSequence = this.Jj.runQueryOnBackgroundThread(paramCharSequence);
  ...
  {
    paramCharSequence = this.Jj.getCursor();
    if ((paramFilterResults.values != null) && (paramFilterResults.values != paramCharSequence)) {
      this.Jj.changeCursor((Cursor)paramFilterResults.values);
    }
  }
...
/* Location:              /home/qerwtr546/Documents/Vent Source/dex2jar-2.0/classes-dex2jar.jar!/android/support/v4/widget/g.class
