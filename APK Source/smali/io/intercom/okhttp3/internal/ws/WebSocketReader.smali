...
# direct methods
.method constructor <init>(ZLio/intercom/b/e;Lio/intercom/okhttp3/internal/ws/WebSocketReader$FrameCallback;)V
    .locals 2
    ...
    iput-object p2, p0, Lio/intercom/okhttp3/internal/ws/WebSocketReader;->source:Lio/intercom/b/e;
...
.method private readControlFrame()V
    ...
    new-instance v6, Lio/intercom/b/c;

    invoke-direct {v6}, Lio/intercom/b/c;-><init>()V
    ...
    iget-boolean v0, p0, Lio/intercom/okhttp3/internal/ws/WebSocketReader;->isClient:Z

    if-eqz v0, :cond_2

    iget-object v0, p0, Lio/intercom/okhttp3/internal/ws/WebSocketReader;->source:Lio/intercom/b/e;

    iget-wide v2, p0, Lio/intercom/okhttp3/internal/ws/WebSocketReader;->frameLength:J

    invoke-interface {v0, v6, v2, v3}, Lio/intercom/b/e;->a(Lio/intercom/b/c;J)V
    ...
    :cond_1
    iget-object v0, p0, Lio/intercom/okhttp3/internal/ws/WebSocketReader;->maskBuffer:[B

    int-to-long v1, v7

    iget-object v3, p0, Lio/intercom/okhttp3/internal/ws/WebSocketReader;->maskKey:[B
    ...
    invoke-virtual {v6, v0, v8, v7}, Lio/intercom/b/c;->b([BII)Lio/intercom/b/c;
    ...
    iput-wide v0, p0, Lio/intercom/okhttp3/internal/ws/WebSocketReader;->frameBytesRead:J
    ...
    iget-object v1, p0, Lio/intercom/okhttp3/internal/ws/WebSocketReader;->source:Lio/intercom/b/e;

    iget-object v2, p0, Lio/intercom/okhttp3/internal/ws/WebSocketReader;->maskBuffer:[B

    invoke-interface {v1, v2, v8, v0}, Lio/intercom/b/e;->read([BII)I
    ...
    invoke-virtual {v6}, Lio/intercom/b/c;->readByteString()Lio/intercom/b/f;

    move-result-object v1

    invoke-interface {v0, v1}, Lio/intercom/okhttp3/internal/ws/WebSocketReader$FrameCallback;->onReadPing(Lio/intercom/b/f;)V
    ...
    invoke-interface {v0, v1}, Lio/intercom/okhttp3/internal/ws/WebSocketReader$FrameCallback;->onReadPong(Lio/intercom/b/f;)V
    ...
    iget-wide v2, v6, Lio/intercom/b/c;->size:J
    ...
    invoke-virtual {v6}, Lio/intercom/b/c;->readShort()S

    move-result v1

    invoke-virtual {v6}, Lio/intercom/b/c;->Ky()Ljava/lang/String;
    ...
    :cond_4
    iget-object v2, p0, Lio/intercom/okhttp3/internal/ws/WebSocketReader;->frameCallback:Lio/intercom/okhttp3/internal/ws/WebSocketReader$FrameCallback;

    invoke-interface {v2, v1, v0}, Lio/intercom/okhttp3/internal/ws/WebSocketReader$FrameCallback;->onReadClose(ILjava/lang/String;)V
...
.method private readHeader()V
    ...
    invoke-virtual {v0, v4, v5, v3}, Lio/intercom/b/t;->timeout(JLjava/util/concurrent/TimeUnit;)Lio/intercom/b/t;
    ...
    invoke-interface {v1}, Lio/intercom/b/e;->timeout()Lio/intercom/b/t;

    move-result-object v1

    sget-object v2, Ljava/util/concurrent/TimeUnit;->NANOSECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v1, v4, v5, v2}, Lio/intercom/b/t;->timeout(JLjava/util/concurrent/TimeUnit;)Lio/intercom/b/t;
    ...
    :cond_c
    iput-wide v8, p0, Lio/intercom/okhttp3/internal/ws/WebSocketReader;->frameBytesRead:J
    ...
    invoke-interface {v0}, Lio/intercom/b/e;->readLong()J
    ...
    invoke-interface {v0, v1}, Lio/intercom/b/e;->readFully([B)V

    :cond_f
    return-void
.end method

.method private readMessage(Lio/intercom/b/c;)V
    .locals 10
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iget-object v2, p0, Lio/intercom/okhttp3/internal/ws/WebSocketReader;->source:Lio/intercom/b/e;

    iget-object v3, p0, Lio/intercom/okhttp3/internal/ws/WebSocketReader;->maskBuffer:[B

    long-to-int v0, v0

    invoke-interface {v2, v3, v6, v0}, Lio/intercom/b/e;->read([BII)I
    ...
    invoke-virtual {p1, v0, v6, v3}, Lio/intercom/b/c;->b([BII)Lio/intercom/b/c;
    ...
    invoke-interface {v2, p1, v0, v1}, Lio/intercom/b/e;->read(Lio/intercom/b/c;J)J
...
.method private readMessageFrame()V
    ...
    invoke-direct {p0, v1}, Lio/intercom/okhttp3/internal/ws/WebSocketReader;->readMessage(Lio/intercom/b/c;)V
    ...
    invoke-interface {v0, v1}, Lio/intercom/okhttp3/internal/ws/WebSocketReader$FrameCallback;->onReadMessage(Lio/intercom/b/f;)V
