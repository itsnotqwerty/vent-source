...
# instance fields
.field final aY:Landroid/arch/lifecycle/e;

.field final synthetic aZ:Landroid/arch/lifecycle/LiveData;


# direct methods
.method public constructor <init>(Landroid/arch/lifecycle/LiveData;Landroid/arch/lifecycle/e;Landroid/arch/lifecycle/k;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Landroid/arch/lifecycle/LiveData$LifecycleBoundObserver;->aZ:Landroid/arch/lifecycle/LiveData;
    ...
    iput-object p2, p0, Landroid/arch/lifecycle/LiveData$LifecycleBoundObserver;->aY:Landroid/arch/lifecycle/e;
...
.method public final a(Landroid/arch/lifecycle/e;Landroid/arch/lifecycle/c$a;)V
    ...
    iget-object v0, p0, Landroid/arch/lifecycle/LiveData$LifecycleBoundObserver;->aY:Landroid/arch/lifecycle/e;
    ...
    iget-object v0, p0, Landroid/arch/lifecycle/LiveData$LifecycleBoundObserver;->aZ:Landroid/arch/lifecycle/LiveData;

    iget-object v1, p0, Landroid/arch/lifecycle/LiveData$LifecycleBoundObserver;->ba:Landroid/arch/lifecycle/k;
    ...
    invoke-virtual {p0, v0}, Landroid/arch/lifecycle/LiveData$LifecycleBoundObserver;->g(Z)V
...
.method final b(Landroid/arch/lifecycle/e;)Z
    .locals 1
