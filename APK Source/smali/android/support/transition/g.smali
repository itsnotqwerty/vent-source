...
.method public constructor <init>(I)V
    ...
    :cond_0
    iput p1, p0, Landroid/support/transition/as;->ow:I
...
.method private b(Landroid/view/View;FF)Landroid/animation/Animator;
    ...
    :cond_0
    invoke-static {p1, p2}, Landroid/support/transition/al;->c(Landroid/view/View;F)V

    sget-object v0, Landroid/support/transition/al;->vB:Landroid/util/Property;
...
.method public final a(Landroid/view/View;Landroid/support/transition/z;)Landroid/animation/Animator;
    ...
    :goto_0
    invoke-direct {p0, p1, v0, v3}, Landroid/support/transition/g;->b(Landroid/view/View;FF)Landroid/animation/Animator;
...
.method public final b(Landroid/view/View;Landroid/support/transition/z;)Landroid/animation/Animator;
    ...
    invoke-direct {p0, p1, v0, v1}, Landroid/support/transition/g;->b(Landroid/view/View;FF)Landroid/animation/Animator;
...
.method public final b(Landroid/support/transition/z;)V
    ...
    invoke-super {p0, p1}, Landroid/support/transition/as;->b(Landroid/support/transition/z;)V
