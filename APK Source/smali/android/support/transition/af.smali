...
# static fields
.field private static vj:Landroid/animation/LayoutTransition;

.field private static vk:Ljava/lang/reflect/Field;

.field private static vl:Z

.field private static vm:Ljava/lang/reflect/Method;
...
# virtual methods
.method public b(Landroid/view/ViewGroup;)Landroid/support/transition/ad;
    .locals 1

    invoke-static {p1}, Landroid/support/transition/ai;->z(Landroid/view/View;)Landroid/support/transition/ai;
...
.method public c(Landroid/view/ViewGroup;Z)V
    ...
    sget-object v1, Landroid/support/transition/af;->vj:Landroid/animation/LayoutTransition;
    ...
    sput-object v1, Landroid/support/transition/af;->vj:Landroid/animation/LayoutTransition;
    ...
    sget-boolean v1, Landroid/support/transition/af;->vn:Z
    ...
    sput-object v1, Landroid/support/transition/af;->vm:Ljava/lang/reflect/Method;
    ...
    :goto_0
    sput-boolean v4, Landroid/support/transition/af;->vn:Z

    :cond_1
    sget-object v1, Landroid/support/transition/af;->vm:Ljava/lang/reflect/Method;
    ...
    :cond_3
    sget-object v0, Landroid/support/transition/af;->vj:Landroid/animation/LayoutTransition;
    ...
    sget-boolean v1, Landroid/support/transition/af;->vl:Z
    ...
    sput-object v1, Landroid/support/transition/af;->vk:Ljava/lang/reflect/Field;
    ...
    :goto_3
    sput-boolean v4, Landroid/support/transition/af;->vl:Z

    :cond_6
    sget-object v1, Landroid/support/transition/af;->vk:Ljava/lang/reflect/Field;
