...
.field final qB:Landroid/graphics/drawable/Drawable$Callback;

.field private qx:Landroid/support/c/a/c$a;

.field private qy:Landroid/animation/ArgbEvaluator;

.field private qz:Landroid/animation/Animator$AnimatorListener;
...
.method private constructor <init>(Landroid/content/Context;B)V
    ...
    iput-object v0, p0, Landroid/support/c/a/c;->qy:Landroid/animation/ArgbEvaluator;

    iput-object v0, p0, Landroid/support/c/a/c;->qz:Landroid/animation/Animator$AnimatorListener;

    iput-object v0, p0, Landroid/support/c/a/c;->qA:Ljava/util/ArrayList;

    new-instance v0, Landroid/support/c/a/c$1;

    invoke-direct {v0, p0}, Landroid/support/c/a/c$1;-><init>(Landroid/support/c/a/c;)V

    iput-object v0, p0, Landroid/support/c/a/c;->qB:Landroid/graphics/drawable/Drawable$Callback;
    ...
    iput-object v0, p0, Landroid/support/c/a/c;->qx:Landroid/support/c/a/c$a;
...
.method private a(Landroid/animation/Animator;)V
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/c/a/c;->qy:Landroid/animation/ArgbEvaluator;
...
.method public final applyTheme(Landroid/content/res/Resources$Theme;)V
    ...
    iget-object v0, p0, Landroid/support/c/a/c;->qN:Landroid/graphics/drawable/Drawable;
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/c/a/c;->qx:Landroid/support/c/a/c$a;

    iget-object v0, v0, Landroid/support/c/a/c$a;->qE:Landroid/support/c/a/i;

    invoke-virtual {v0, p1}, Landroid/support/c/a/i;->draw(Landroid/graphics/Canvas;)V

    iget-object v0, p0, Landroid/support/c/a/c;->qx:Landroid/support/c/a/c$a;

    iget-object v0, v0, Landroid/support/c/a/c$a;->qF:Landroid/animation/AnimatorSet;
...
.method public final getChangingConfigurations()I
    ...
    iget-object v1, p0, Landroid/support/c/a/c;->qx:Landroid/support/c/a/c$a;

    iget v1, v1, Landroid/support/c/a/c$a;->qD:I
...
.method public final getConstantState()Landroid/graphics/drawable/Drawable$ConstantState;
    ...
    iget-object v1, p0, Landroid/support/c/a/c;->qN:Landroid/graphics/drawable/Drawable;
...
.method public final inflate(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    sget-object v0, Landroid/support/c/a/a;->qp:[I
    ...
    iput-boolean v7, v2, Landroid/support/c/a/i;->qT:Z

    iget-object v3, p0, Landroid/support/c/a/c;->qB:Landroid/graphics/drawable/Drawable$Callback;

    invoke-virtual {v2, v3}, Landroid/support/c/a/i;->setCallback(Landroid/graphics/drawable/Drawable$Callback;)V

    iget-object v3, p0, Landroid/support/c/a/c;->qx:Landroid/support/c/a/c$a;

    iget-object v3, v3, Landroid/support/c/a/c$a;->qE:Landroid/support/c/a/i;
    ...
    iput-object v2, v3, Landroid/support/c/a/c$a;->qE:Landroid/support/c/a/i;
    ...
    sget-object v0, Landroid/support/c/a/a;->qq:[I
    ...
    :goto_3
    iget-object v4, p0, Landroid/support/c/a/c;->qx:Landroid/support/c/a/c$a;

    iget-object v4, v4, Landroid/support/c/a/c$a;->qE:Landroid/support/c/a/i;

    iget-object v4, v4, Landroid/support/c/a/i;->qP:Landroid/support/c/a/i$f;

    iget-object v4, v4, Landroid/support/c/a/i$f;->rM:Landroid/support/c/a/i$e;

    iget-object v4, v4, Landroid/support/c/a/i$e;->rL:Landroid/support/v4/g/a;
    ...
    iput-object v5, v4, Landroid/support/c/a/c$a;->qH:Landroid/support/v4/g/a;
    ...
    iget-object v4, v4, Landroid/support/c/a/c$a;->qH:Landroid/support/v4/g/a;
    ...
    iget-object v1, v0, Landroid/support/c/a/c$a;->qF:Landroid/animation/AnimatorSet;
    ...
    iput-object v1, v0, Landroid/support/c/a/c$a;->qF:Landroid/animation/AnimatorSet;

    :cond_c
    iget-object v1, v0, Landroid/support/c/a/c$a;->qF:Landroid/animation/AnimatorSet;

    iget-object v0, v0, Landroid/support/c/a/c$a;->qG:Ljava/util/ArrayList;
