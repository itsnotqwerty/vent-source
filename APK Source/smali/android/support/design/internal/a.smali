...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/design/internal/a;->if:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Landroid/support/design/internal/a;->ig:Landroid/graphics/Rect;

    const/16 v0, 0x77

    iput v0, p0, Landroid/support/design/internal/a;->ih:I

    iput-boolean v3, p0, Landroid/support/design/internal/a;->ii:Z

    iput-boolean v1, p0, Landroid/support/design/internal/a;->ij:Z
    ...
    iget v2, p0, Landroid/support/design/internal/a;->ih:I

    invoke-virtual {v0, v1, v2}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v1

    iput v1, p0, Landroid/support/design/internal/a;->ih:I
    ...
    iput-boolean v1, p0, Landroid/support/design/internal/a;->ii:Z
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Landroid/support/design/internal/a;->ie:Landroid/graphics/drawable/Drawable;

    if-eqz v0, :cond_1

    iget-object v0, p0, Landroid/support/design/internal/a;->ie:Landroid/graphics/drawable/Drawable;

    iget-boolean v1, p0, Landroid/support/design/internal/a;->ij:Z

    if-eqz v1, :cond_0

    iput-boolean v6, p0, Landroid/support/design/internal/a;->ij:Z

    iget-object v1, p0, Landroid/support/design/internal/a;->if:Landroid/graphics/Rect;

    iget-object v2, p0, Landroid/support/design/internal/a;->ig:Landroid/graphics/Rect;
    ...
    iget-boolean v5, p0, Landroid/support/design/internal/a;->ii:Z
    ...
    :goto_0
    iget v3, p0, Landroid/support/design/internal/a;->ih:I
...
.method public getForegroundGravity()I
    ...
    iget v0, p0, Landroid/support/design/internal/a;->ih:I
...
.method protected onLayout(ZIIII)V
    ...
    iget-boolean v0, p0, Landroid/support/design/internal/a;->ij:Z

    or-int/2addr v0, p1

    iput-boolean v0, p0, Landroid/support/design/internal/a;->ij:Z
...
.method public setForeground(Landroid/graphics/drawable/Drawable;)V
    ...
    :cond_0
    iput-object p1, p0, Landroid/support/design/internal/a;->ie:Landroid/graphics/drawable/Drawable;
...
.method public setForegroundGravity(I)V
    ...
    iget-object v1, p0, Landroid/support/design/internal/a;->ie:Landroid/graphics/drawable/Drawable;
