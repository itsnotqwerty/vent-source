...
# static fields
.field private static final VU:Landroid/graphics/PorterDuff$Mode;

.field private static VV:Landroid/support/v7/widget/m;

.field private static final VW:Landroid/support/v7/widget/m$b;
...
.field private static final Wb:[I

.field private static final Wc:[I


# instance fields
.field private Wd:Ljava/util/WeakHashMap;
...
.field private We:Landroid/support/v4/g/a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private Wf:Landroid/support/v4/g/n;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/support/v4/g/n",
            "<",
...
.field public final Wg:Ljava/lang/Object;

.field public final Wh:Ljava/util/WeakHashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/WeakHashMap",
            "<",
...
.field private Wi:Landroid/util/TypedValue;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/m;->VU:Landroid/graphics/PorterDuff$Mode;

    new-instance v0, Landroid/support/v7/widget/m$b;

    invoke-direct {v0}, Landroid/support/v7/widget/m$b;-><init>()V

    sput-object v0, Landroid/support/v7/widget/m;->VW:Landroid/support/v7/widget/m$b;
    ...
    sput-object v0, Landroid/support/v7/widget/m;->VX:[I
    ...
    sput-object v0, Landroid/support/v7/widget/m;->VY:[I
    ...
    sput-object v0, Landroid/support/v7/widget/m;->VZ:[I
    ...
    sput-object v0, Landroid/support/v7/widget/m;->Wa:[I
    ...
    sput-object v0, Landroid/support/v7/widget/m;->Wb:[I
    ...
    sput-object v0, Landroid/support/v7/widget/m;->Wc:[I
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/m;->Wg:Ljava/lang/Object;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/m;->Wh:Ljava/util/WeakHashMap;
...
.method public static a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    sget-object v0, Landroid/support/v7/widget/m;->VW:Landroid/support/v7/widget/m$b;

    invoke-static {p0, p1}, Landroid/support/v7/widget/m$b;->b(ILandroid/graphics/PorterDuff$Mode;)I
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/m$b;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object v1, Landroid/support/v7/widget/m;->VW:Landroid/support/v7/widget/m$b;
    ...
    invoke-virtual {v1, v2, v0}, Landroid/support/v7/widget/m$b;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private a(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/m;->Wg:Ljava/lang/Object;

    monitor-enter v3

    :try_start_0
    iget-object v0, p0, Landroid/support/v7/widget/m;->Wh:Ljava/util/WeakHashMap;
    ...
    :cond_0
    invoke-virtual {v0, p2, p3}, Landroid/support/v4/g/f;->get(J)Ljava/lang/Object;
    ...
    iget v4, v0, Landroid/support/v4/g/f;->ai:I

    invoke-static {v1, v4, p2, p3}, Landroid/support/v4/g/c;->a([JIJ)I

    move-result v1

    if-ltz v1, :cond_2

    iget-object v4, v0, Landroid/support/v4/g/f;->EC:[Ljava/lang/Object;

    aget-object v4, v4, v1

    sget-object v5, Landroid/support/v4/g/f;->Ez:Ljava/lang/Object;
    ...
    iput-boolean v1, v0, Landroid/support/v4/g/f;->EA:Z
...
.method private static a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p0}, Landroid/support/v7/widget/am;->m(Landroid/graphics/drawable/Drawable;)Z
    ...
    sget-object p2, Landroid/support/v7/widget/m;->VU:Landroid/graphics/PorterDuff$Mode;
...
.method static a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bm;[I)V
    ...
    :cond_1
    iget-boolean v0, p1, Landroid/support/v7/widget/bm;->ajR:Z

    if-nez v0, :cond_2

    iget-boolean v0, p1, Landroid/support/v7/widget/bm;->ajQ:Z
    ...
    iget-object v0, p1, Landroid/support/v7/widget/bm;->ajP:Landroid/content/res/ColorStateList;

    :goto_1
    iget-boolean v2, p1, Landroid/support/v7/widget/bm;->ajQ:Z

    if-eqz v2, :cond_5

    iget-object v2, p1, Landroid/support/v7/widget/bm;->rO:Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_5
    sget-object v2, Landroid/support/v7/widget/m;->VU:Landroid/graphics/PorterDuff$Mode;
...
.method private a(Ljava/lang/String;Landroid/support/v7/widget/m$c;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/m;->We:Landroid/support/v4/g/a;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/m;->We:Landroid/support/v4/g/a;
...
.method static a(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    sget-object v6, Landroid/support/v7/widget/m;->VU:Landroid/graphics/PorterDuff$Mode;

    sget-object v2, Landroid/support/v7/widget/m;->VX:[I
    ...
    invoke-static {p2}, Landroid/support/v7/widget/am;->m(Landroid/graphics/drawable/Drawable;)Z
    ...
    :cond_0
    invoke-static {p0, v4}, Landroid/support/v7/widget/bk;->k(Landroid/content/Context;I)I
    ...
    :cond_2
    sget-object v2, Landroid/support/v7/widget/m;->VZ:[I
    ...
    :cond_3
    sget-object v2, Landroid/support/v7/widget/m;->Wa:[I
...
.method private a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    iget-object v2, p0, Landroid/support/v7/widget/m;->Wg:Ljava/lang/Object;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/m;->Wh:Ljava/util/WeakHashMap;
    ...
    invoke-virtual {v0, p2, p3, v3}, Landroid/support/v4/g/f;->put(JLjava/lang/Object;)V
...
.method public static gh()Landroid/support/v7/widget/m;
    .locals 3

    sget-object v0, Landroid/support/v7/widget/m;->VV:Landroid/support/v7/widget/m;
    ...
    sput-object v0, Landroid/support/v7/widget/m;->VV:Landroid/support/v7/widget/m;
...
.method private static i(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, v2}, Landroid/support/v7/widget/bk;->k(Landroid/content/Context;I)I

    move-result v2

    sget v3, Landroid/support/v7/a/a$a;->colorButtonNormal:I

    invoke-static {p0, v3}, Landroid/support/v7/widget/bk;->m(Landroid/content/Context;I)I

    move-result v3

    sget-object v4, Landroid/support/v7/widget/bk;->ajJ:[I

    aput-object v4, v0, v5

    aput v3, v1, v5

    sget-object v3, Landroid/support/v7/widget/bk;->PRESSED_STATE_SET:[I

    aput-object v3, v0, v6

    invoke-static {v2, p1}, Landroid/support/v4/a/a;->l(II)I

    move-result v3

    aput v3, v1, v6

    sget-object v3, Landroid/support/v7/widget/bk;->FOCUSED_STATE_SET:[I
    ...
    sget-object v2, Landroid/support/v7/widget/bk;->EMPTY_STATE_SET:[I
...
.method public final a(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    iget-boolean v0, p0, Landroid/support/v7/widget/m;->Wj:Z

    if-nez v0, :cond_3

    iput-boolean v2, p0, Landroid/support/v7/widget/m;->Wj:Z
    ...
    :cond_1
    iput-boolean v1, p0, Landroid/support/v7/widget/m;->Wj:Z
    ...
    :cond_3
    invoke-virtual {p0, p1, p2}, Landroid/support/v7/widget/m;->g(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-nez v0, :cond_6

    iget-object v0, p0, Landroid/support/v7/widget/m;->Wi:Landroid/util/TypedValue;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/m;->Wi:Landroid/util/TypedValue;

    :cond_4
    iget-object v3, p0, Landroid/support/v7/widget/m;->Wi:Landroid/util/TypedValue;
...
.method final a(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, p2}, Landroid/support/v7/widget/m;->h(Landroid/content/Context;I)Landroid/content/res/ColorStateList;

    move-result-object v1

    if-eqz v1, :cond_3

    invoke-static {p4}, Landroid/support/v7/widget/am;->m(Landroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {p1, v2}, Landroid/support/v7/widget/bk;->k(Landroid/content/Context;I)I

    move-result v2

    sget-object v3, Landroid/support/v7/widget/m;->VU:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {p1, v1}, Landroid/support/v7/widget/bk;->k(Landroid/content/Context;I)I
    ...
    invoke-static {p1, v2}, Landroid/support/v7/widget/bk;->m(Landroid/content/Context;I)I
...
.method final g(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/m;->Wf:Landroid/support/v4/g/n;

    if-eqz v0, :cond_2

    iget-object v0, p0, Landroid/support/v7/widget/m;->Wf:Landroid/support/v4/g/n;

    invoke-virtual {v0, p2}, Landroid/support/v4/g/n;->get(I)Ljava/lang/Object;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/m;->We:Landroid/support/v4/g/a;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/m;->Wf:Landroid/support/v4/g/n;
    ...
    :cond_4
    iget-object v2, p0, Landroid/support/v7/widget/m;->Wi:Landroid/util/TypedValue;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/m;->Wf:Landroid/support/v4/g/n;

    const-string v2, "appcompat_skip_skip"

    invoke-virtual {v1, p2, v2}, Landroid/support/v4/g/n;->append(ILjava/lang/Object;)V
    ...
    iget-object v7, p0, Landroid/support/v7/widget/m;->Wf:Landroid/support/v4/g/n;

    invoke-virtual {v7, p2, v0}, Landroid/support/v4/g/n;->append(ILjava/lang/Object;)V

    iget-object v7, p0, Landroid/support/v7/widget/m;->We:Landroid/support/v4/g/a;
...
.method final h(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/m;->Wd:Ljava/util/WeakHashMap;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/m;->Wd:Ljava/util/WeakHashMap;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/m;->Wd:Ljava/util/WeakHashMap;

    invoke-virtual {v2, p1, v0}, Ljava/util/WeakHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_1
    invoke-virtual {v0, p2, v1}, Landroid/support/v4/g/n;->append(ILjava/lang/Object;)V
    ...
    invoke-static {p1, v1}, Landroid/support/v7/widget/bk;->l(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget-object v3, Landroid/support/v7/widget/bk;->ajJ:[I
    ...
    sget-object v3, Landroid/support/v7/widget/bk;->ik:[I

    aput-object v3, v0, v5

    sget v3, Landroid/support/v7/a/a$a;->colorControlActivated:I

    invoke-static {p1, v3}, Landroid/support/v7/widget/bk;->k(Landroid/content/Context;I)I

    move-result v3

    aput v3, v2, v5

    sget-object v3, Landroid/support/v7/widget/bk;->EMPTY_STATE_SET:[I
    ...
    invoke-static {p1, v1}, Landroid/support/v7/widget/bk;->m(Landroid/content/Context;I)I

    move-result v1

    aput v1, v2, v4

    sget-object v1, Landroid/support/v7/widget/bk;->ik:[I
    ...
    sget-object v1, Landroid/support/v7/widget/bk;->EMPTY_STATE_SET:[I
    ...
    invoke-static {p1, v0}, Landroid/support/v7/widget/bk;->k(Landroid/content/Context;I)I

    move-result v0

    invoke-static {p1, v0}, Landroid/support/v7/widget/m;->i(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v4}, Landroid/support/v7/widget/m;->i(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :cond_e
    sget-object v1, Landroid/support/v7/widget/m;->VY:[I
    ...
    invoke-static {p1, v0}, Landroid/support/v7/widget/bk;->l(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :cond_f
    sget-object v1, Landroid/support/v7/widget/m;->Wb:[I
    ...
    :cond_10
    sget-object v1, Landroid/support/v7/widget/m;->Wc:[I
