...
.field private static final Xn:Landroid/support/v7/widget/ah;
...
.field final Xr:Landroid/graphics/Rect;

.field final Xs:Landroid/graphics/Rect;

.field private final Xt:Landroid/support/v7/widget/ag;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/CardView;->Xm:[I
    ...
    sput-object v0, Landroid/support/v7/widget/CardView;->Xn:Landroid/support/v7/widget/ah;

    :goto_0
    sget-object v0, Landroid/support/v7/widget/CardView;->Xn:Landroid/support/v7/widget/ah;

    invoke-interface {v0}, Landroid/support/v7/widget/ah;->gv()V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/CardView;->Xr:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Landroid/support/v7/widget/CardView;->Xs:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/CardView;->Xt:Landroid/support/v7/widget/ag;
    ...
    iput-boolean v0, p0, Landroid/support/v7/widget/CardView;->mu:Z
    ...
    iput-boolean v0, p0, Landroid/support/v7/widget/CardView;->Xo:Z
    ...
    iget-object v2, p0, Landroid/support/v7/widget/CardView;->Xr:Landroid/graphics/Rect;
    ...
    iput v0, p0, Landroid/support/v7/widget/CardView;->Xp:I
    ...
    iput v0, p0, Landroid/support/v7/widget/CardView;->Xq:I

    invoke-virtual {v1}, Landroid/content/res/TypedArray;->recycle()V

    sget-object v0, Landroid/support/v7/widget/CardView;->Xn:Landroid/support/v7/widget/ah;

    iget-object v1, p0, Landroid/support/v7/widget/CardView;->Xt:Landroid/support/v7/widget/ag;

    move-object v2, p1

    invoke-interface/range {v0 .. v6}, Landroid/support/v7/widget/ah;->a(Landroid/support/v7/widget/ag;Landroid/content/Context;Landroid/content/res/ColorStateList;FFF)V
    ...
    sget-object v2, Landroid/support/v7/widget/CardView;->Xm:[I
...
.method public getContentPaddingBottom()I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/CardView;->Xr:Landroid/graphics/Rect;
...
.method public getPreventCornerOverlap()Z
    ...
    iget-boolean v0, p0, Landroid/support/v7/widget/CardView;->Xo:Z
...
.method public getUseCompatPadding()Z
    ...
    iget-boolean v0, p0, Landroid/support/v7/widget/CardView;->mu:Z
...
.method protected onMeasure(II)V
    ...
    :sswitch_0
    sget-object v1, Landroid/support/v7/widget/CardView;->Xn:Landroid/support/v7/widget/ah;

    iget-object v2, p0, Landroid/support/v7/widget/CardView;->Xt:Landroid/support/v7/widget/ag;
...
.method public setMinimumHeight(I)V
    ...
    iput p1, p0, Landroid/support/v7/widget/CardView;->Xq:I
...
.method public setMinimumWidth(I)V
    ...
    iput p1, p0, Landroid/support/v7/widget/CardView;->Xp:I
...
.method public setPreventCornerOverlap(Z)V
    ...
    iput-boolean p1, p0, Landroid/support/v7/widget/CardView;->Xo:Z
...
.method public setUseCompatPadding(Z)V
    ...
    iput-boolean p1, p0, Landroid/support/v7/widget/CardView;->mu:Z
