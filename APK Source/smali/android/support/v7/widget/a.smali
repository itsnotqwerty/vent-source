...
# instance fields
.field protected final Te:Landroid/support/v7/widget/a$a;

.field protected Tf:Landroid/support/v7/widget/d;

.field protected Tg:I

.field protected Th:Landroid/support/v4/view/v;
...
.method constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/a;->Te:Landroid/support/v7/widget/a$a;
...
.method protected static e(Landroid/view/View;II)I
    .locals 2
...
# virtual methods
.method public b(IJ)Landroid/support/v4/view/v;
    .locals 2

    const/4 v1, 0x0

    iget-object v0, p0, Landroid/support/v7/widget/a;->Th:Landroid/support/v4/view/v;
    ...
    :cond_1
    invoke-static {p0}, Landroid/support/v4/view/r;->S(Landroid/view/View;)Landroid/support/v4/view/v;

    move-result-object v0

    const/high16 v1, 0x3f800000    # 1.0f

    invoke-virtual {v0, v1}, Landroid/support/v4/view/v;->k(F)Landroid/support/v4/view/v;

    move-result-object v0

    invoke-virtual {v0, p2, p3}, Landroid/support/v4/view/v;->e(J)Landroid/support/v4/view/v;

    iget-object v1, p0, Landroid/support/v7/widget/a;->Te:Landroid/support/v7/widget/a$a;

    invoke-virtual {v1, v0, p1}, Landroid/support/v7/widget/a$a;->a(Landroid/support/v4/view/v;I)Landroid/support/v7/widget/a$a;
...
.method public getAnimatedVisibility()I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/a;->Te:Landroid/support/v7/widget/a$a;

    iget v0, v0, Landroid/support/v7/widget/a$a;->vQ:I
...
.method public getContentHeight()I
    ...
    iget v0, p0, Landroid/support/v7/widget/a;->Tg:I
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/a;->Tf:Landroid/support/v7/widget/d;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/a;->Tf:Landroid/support/v7/widget/d;

    invoke-virtual {v0}, Landroid/support/v7/widget/d;->fG()V
...
.method public setContentHeight(I)V
    ...
    iput p1, p0, Landroid/support/v7/widget/a;->Tg:I
