...
.method public constructor <init>(Landroid/support/v7/widget/d;Landroid/content/Context;Landroid/support/v7/view/menu/u;Landroid/view/View;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/d$a;->Uy:Landroid/support/v7/widget/d;
    ...
    iget-object v0, p1, Landroid/support/v7/widget/d;->Ud:Landroid/support/v7/widget/d$d;
    ...
    :goto_0
    iput-object v0, p0, Landroid/support/v7/view/menu/n;->mc:Landroid/view/View;

    :cond_0
    iget-object v0, p1, Landroid/support/v7/widget/d;->Uw:Landroid/support/v7/widget/d$f;

    invoke-virtual {p0, v0}, Landroid/support/v7/widget/d$a;->b(Landroid/support/v7/view/menu/o$a;)V
...
.method protected final onDismiss()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/d$a;->Uy:Landroid/support/v7/widget/d;

    const/4 v1, 0x0

    iput-object v1, v0, Landroid/support/v7/widget/d;->Ut:Landroid/support/v7/widget/d$a;

    iget-object v0, p0, Landroid/support/v7/widget/d$a;->Uy:Landroid/support/v7/widget/d;

    const/4 v1, 0x0

    iput v1, v0, Landroid/support/v7/widget/d;->Ux:I
