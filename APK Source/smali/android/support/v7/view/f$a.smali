...
.field final PB:Landroid/support/v4/g/m;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field final Pz:Landroid/view/ActionMode$Callback;
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/ActionMode$Callback;)V
    ...
    iput-object p2, p0, Landroid/support/v7/view/f$a;->Pz:Landroid/view/ActionMode$Callback;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Landroid/support/v7/view/f$a;->PA:Ljava/util/ArrayList;

    new-instance v0, Landroid/support/v4/g/m;

    invoke-direct {v0}, Landroid/support/v4/g/m;-><init>()V

    iput-object v0, p0, Landroid/support/v7/view/f$a;->PB:Landroid/support/v4/g/m;
...
.method private b(Landroid/view/Menu;)Landroid/view/Menu;
    ...
    iget-object v0, p0, Landroid/support/v7/view/f$a;->PB:Landroid/support/v4/g/m;
    ...
    iget-object v1, p0, Landroid/support/v7/view/f$a;->PB:Landroid/support/v4/g/m;
...
.method public final a(Landroid/support/v7/view/b;)V
    ...
    iget-object v0, p0, Landroid/support/v7/view/f$a;->Pz:Landroid/view/ActionMode$Callback;
...
.method public final b(Landroid/support/v7/view/b;)Landroid/view/ActionMode;
    ...
    iget-object v1, p0, Landroid/support/v7/view/f$a;->PA:Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Landroid/support/v7/view/f$a;->PA:Ljava/util/ArrayList;
    ...
    iget-object v3, v0, Landroid/support/v7/view/f;->Py:Landroid/support/v7/view/b;
