...
# static fields
.field private static final RY:[I
...
.field public Sb:Landroid/support/v7/view/menu/h$a;
...
.field private Si:Landroid/view/ContextMenu$ContextMenuInfo;

.field Sj:Ljava/lang/CharSequence;

.field Sk:Landroid/graphics/drawable/Drawable;

.field Sl:Landroid/view/View;
...
.field private Ss:Ljava/util/concurrent/CopyOnWriteArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field St:Landroid/support/v7/view/menu/j;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/view/menu/h;->RY:[I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v1, p0, Landroid/support/v7/view/menu/h;->Sh:I

    iput-boolean v1, p0, Landroid/support/v7/view/menu/h;->Sm:Z

    iput-boolean v1, p0, Landroid/support/v7/view/menu/h;->Sn:Z

    iput-boolean v1, p0, Landroid/support/v7/view/menu/h;->So:Z

    iput-boolean v1, p0, Landroid/support/v7/view/menu/h;->Sp:Z

    iput-boolean v1, p0, Landroid/support/v7/view/menu/h;->Sq:Z

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iput-object v2, p0, Landroid/support/v7/view/menu/h;->Sr:Ljava/util/ArrayList;

    new-instance v2, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v2}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v2, p0, Landroid/support/v7/view/menu/h;->Ss:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iput-object v2, p0, Landroid/support/v7/view/menu/h;->Gj:Ljava/util/ArrayList;

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iput-object v2, p0, Landroid/support/v7/view/menu/h;->Sc:Ljava/util/ArrayList;

    iput-boolean v0, p0, Landroid/support/v7/view/menu/h;->Sd:Z

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iput-object v2, p0, Landroid/support/v7/view/menu/h;->Se:Ljava/util/ArrayList;

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iput-object v2, p0, Landroid/support/v7/view/menu/h;->Sf:Ljava/util/ArrayList;

    iput-boolean v0, p0, Landroid/support/v7/view/menu/h;->Sg:Z
    ...
    :goto_0
    iput-boolean v0, p0, Landroid/support/v7/view/menu/h;->Sa:Z
...
.method private a(ILandroid/view/KeyEvent;)Landroid/support/v7/view/menu/j;
    ...
    iget-object v5, p0, Landroid/support/v7/view/menu/h;->Sr:Ljava/util/ArrayList;
    ...
    :cond_2
    invoke-virtual {p0}, Landroid/support/v7/view/menu/h;->fh()Z
...
.method private a(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    sget-object v1, Landroid/support/v7/view/menu/h;->RY:[I
    ...
    iget v7, p0, Landroid/support/v7/view/menu/h;->Sh:I
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/h;->Si:Landroid/view/ContextMenu$ContextMenuInfo;

    if-eqz v1, :cond_2

    iget-object v1, p0, Landroid/support/v7/view/menu/h;->Si:Landroid/view/ContextMenu$ContextMenuInfo;

    iput-object v1, v0, Landroid/support/v7/view/menu/j;->SF:Landroid/view/ContextMenu$ContextMenuInfo;

    :cond_2
    iget-object v1, p0, Landroid/support/v7/view/menu/h;->Gj:Ljava/util/ArrayList;

    iget-object v2, p0, Landroid/support/v7/view/menu/h;->Gj:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/view/menu/h;->J(Z)V
...
.method private a(Ljava/util/List;ILandroid/view/KeyEvent;)V
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/v7/view/menu/h;->Gj:Ljava/util/ArrayList;
...
.method private static b(Ljava/util/ArrayList;I)I
    ...
    iget v0, v0, Landroid/support/v7/view/menu/j;->Qw:I
...
.method private e(IZ)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/view/menu/h;->J(Z)V
...
.method public final I(Z)V
    ...
    iget-boolean v0, p0, Landroid/support/v7/view/menu/h;->Sq:Z
    ...
    iput-boolean v0, p0, Landroid/support/v7/view/menu/h;->Sq:Z

    iget-object v0, p0, Landroid/support/v7/view/menu/h;->Ss:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/h;->Ss:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final J(Z)V
    ...
    iget-boolean v0, p0, Landroid/support/v7/view/menu/h;->Sm:Z

    if-nez v0, :cond_4

    if-eqz p1, :cond_0

    iput-boolean v1, p0, Landroid/support/v7/view/menu/h;->Sd:Z

    iput-boolean v1, p0, Landroid/support/v7/view/menu/h;->Sg:Z
    ...
    invoke-virtual {p0}, Landroid/support/v7/view/menu/h;->fj()V
    ...
    :cond_1
    invoke-interface {v1, p1}, Landroid/support/v7/view/menu/o;->G(Z)V

    goto :goto_0

    :cond_2
    invoke-virtual {p0}, Landroid/support/v7/view/menu/h;->fk()V
...
.method final a(ILjava/lang/CharSequence;ILandroid/graphics/drawable/Drawable;Landroid/view/View;)V
    ...
    iput-object p5, p0, Landroid/support/v7/view/menu/h;->Sl:Landroid/view/View;

    iput-object v1, p0, Landroid/support/v7/view/menu/h;->Sj:Ljava/lang/CharSequence;

    iput-object v1, p0, Landroid/support/v7/view/menu/h;->Sk:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/h;->Sj:Ljava/lang/CharSequence;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/h;->Sk:Landroid/graphics/drawable/Drawable;

    :cond_2
    :goto_2
    iput-object v1, p0, Landroid/support/v7/view/menu/h;->Sl:Landroid/view/View;
    ...
    iput-object p2, p0, Landroid/support/v7/view/menu/h;->Sj:Ljava/lang/CharSequence;
    ...
    iput-object p4, p0, Landroid/support/v7/view/menu/h;->Sk:Landroid/graphics/drawable/Drawable;
...
.method public a(Landroid/support/v7/view/menu/h$a;)V
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/h;->Sb:Landroid/support/v7/view/menu/h$a;
...
.method public final a(Landroid/view/MenuItem;Landroid/support/v7/view/menu/o;I)Z
    ...
    iget-object v4, p1, Landroid/support/v7/view/menu/j;->SC:Landroid/support/v4/view/c;
    ...
    invoke-virtual {p0, v3}, Landroid/support/v7/view/menu/h;->I(Z)V
    ...
    invoke-virtual {p0, v2}, Landroid/support/v7/view/menu/h;->I(Z)V
    ...
    invoke-virtual {v4, v0}, Landroid/support/v4/view/c;->onPrepareSubMenu(Landroid/view/SubMenu;)V
    ...
    iget-object v2, p0, Landroid/support/v7/view/menu/h;->Ss:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final b(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/view/menu/h;->fg()Ljava/lang/String;
...
.method public clear()V
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/h;->St:Landroid/support/v7/view/menu/j;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/view/menu/h;->St:Landroid/support/v7/view/menu/j;

    invoke-virtual {p0, v0}, Landroid/support/v7/view/menu/h;->g(Landroid/support/v7/view/menu/j;)Z
...
.method public clearHeader()V
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/h;->Sl:Landroid/view/View;
...
.method public close()V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/view/menu/h;->I(Z)V
...
.method d(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/h;->Sb:Landroid/support/v7/view/menu/h$a;
...
.method public f(Landroid/support/v7/view/menu/j;)Z
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/h;->St:Landroid/support/v7/view/menu/j;
...
.method fh()Z
    ...
    iget-boolean v0, p0, Landroid/support/v7/view/menu/h;->RZ:Z
...
.method public fi()Z
    ...
    iget-boolean v0, p0, Landroid/support/v7/view/menu/h;->Sa:Z
...
.method public final fj()V
    ...
    iput-boolean v0, p0, Landroid/support/v7/view/menu/h;->Sm:Z
...
.method public final fk()V
    ...
    iget-boolean v0, p0, Landroid/support/v7/view/menu/h;->Sn:Z

    if-eqz v0, :cond_0

    iput-boolean v1, p0, Landroid/support/v7/view/menu/h;->Sn:Z

    iget-boolean v0, p0, Landroid/support/v7/view/menu/h;->So:Z
...
.method public final fn()Ljava/util/ArrayList;
    ...
    iget-boolean v0, p0, Landroid/support/v7/view/menu/h;->Sd:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/view/menu/h;->Sc:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Landroid/support/v7/view/menu/h;->Sc:Ljava/util/ArrayList;
    ...
    :cond_2
    iput-boolean v2, p0, Landroid/support/v7/view/menu/h;->Sd:Z
...
.method public final fo()V
    ...
    invoke-virtual {p0}, Landroid/support/v7/view/menu/h;->fn()Ljava/util/ArrayList;

    move-result-object v4

    iget-boolean v0, p0, Landroid/support/v7/view/menu/h;->Sg:Z
    ...
    :cond_1
    invoke-interface {v1}, Landroid/support/v7/view/menu/o;->fa()Z
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/h;->Se:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    iget-object v0, p0, Landroid/support/v7/view/menu/h;->Sf:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0}, Landroid/support/v7/view/menu/j;->fv()Z

    move-result v5

    if-eqz v5, :cond_3

    iget-object v5, p0, Landroid/support/v7/view/menu/h;->Se:Ljava/util/ArrayList;
    ...
    :cond_3
    iget-object v5, p0, Landroid/support/v7/view/menu/h;->Sf:Ljava/util/ArrayList;
    ...
    :cond_5
    iput-boolean v3, p0, Landroid/support/v7/view/menu/h;->Sg:Z

    goto :goto_0
.end method

.method public final fp()Ljava/util/ArrayList;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-virtual {p0}, Landroid/support/v7/view/menu/h;->fo()V
...
.method public fq()Landroid/support/v7/view/menu/h;
    .locals 0
...
.method public g(Landroid/support/v7/view/menu/j;)Z
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/h;->St:Landroid/support/v7/view/menu/j;
    ...
    :cond_2
    invoke-interface {v1, p1}, Landroid/support/v7/view/menu/o;->d(Landroid/support/v7/view/menu/j;)Z
    ...
    iput-object v1, p0, Landroid/support/v7/view/menu/h;->St:Landroid/support/v7/view/menu/j;
...
.method public hasVisibleItems()Z
    ...
    iget-boolean v0, p0, Landroid/support/v7/view/menu/h;->Su:Z
...
.method public performShortcut(ILandroid/view/KeyEvent;I)Z
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/view/menu/h;->I(Z)V
...
.method public removeGroup(I)V
    ...
    invoke-direct {p0, v3, v1}, Landroid/support/v7/view/menu/h;->e(IZ)V
...
.method public removeItem(I)V
    ...
    invoke-direct {p0, v0, v1}, Landroid/support/v7/view/menu/h;->e(IZ)V
...
.method public setGroupCheckable(IZZ)V
    ...
    invoke-virtual {v0, p3}, Landroid/support/v7/view/menu/j;->K(Z)V
...
.method public setGroupVisible(IZ)V
    ...
    invoke-virtual {v0, p2}, Landroid/support/v7/view/menu/j;->M(Z)Z
...
.method public setQwertyMode(Z)V
    ...
    iput-boolean p1, p0, Landroid/support/v7/view/menu/h;->RZ:Z
