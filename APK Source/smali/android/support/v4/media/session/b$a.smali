...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {p0}, Landroid/support/v4/media/session/b$a;->dk()Z
    ...
    invoke-virtual {p0}, Landroid/support/v4/media/session/b$a;->dl()Landroid/app/PendingIntent;
    ...
    invoke-virtual {p0}, Landroid/support/v4/media/session/b$a;->dm()Landroid/support/v4/media/session/ParcelableVolumeInfo;
    ...
    invoke-virtual {p0}, Landroid/support/v4/media/session/b$a;->dn()Landroid/support/v4/media/MediaMetadataCompat;
    ...
    invoke-virtual {p0}, Landroid/support/v4/media/session/b$a;->do()Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    invoke-virtual {p0}, Landroid/support/v4/media/session/b$a;->dp()Z
    ...
    invoke-virtual {p0}, Landroid/support/v4/media/session/b$a;->dq()Z
    ...
    invoke-virtual {p0}, Landroid/support/v4/media/session/b$a;->dr()I
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/media/session/b$a;->aj(I)V
    ...
    invoke-virtual {p0}, Landroid/support/v4/media/session/b$a;->ds()V
    ...
    invoke-virtual {p0}, Landroid/support/v4/media/session/b$a;->dt()V
    ...
    :cond_1b
    invoke-virtual {p0, v1}, Landroid/support/v4/media/session/b$a;->r(Z)V
    ...
    :cond_1c
    invoke-virtual {p0, v1}, Landroid/support/v4/media/session/b$a;->s(Z)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/media/session/b$a;->ak(I)V
