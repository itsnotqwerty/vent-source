...
# static fields
.field private static bfW:Lcom/google/firebase/messaging/d;


# instance fields
.field private bfX:Landroid/os/Bundle;

.field private bfY:Ljava/lang/reflect/Method;

.field private bfZ:Ljava/lang/reflect/Method;

.field private final bga:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/google/firebase/messaging/d;->bga:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object v0

    iput-object v0, p0, Lcom/google/firebase/messaging/d;->mContext:Landroid/content/Context;
...
.method private final a(Ljava/lang/CharSequence;Ljava/lang/String;ILjava/lang/Integer;Landroid/net/Uri;Landroid/app/PendingIntent;Landroid/app/PendingIntent;Ljava/lang/String;)Landroid/app/Notification;
    ...
    iget-object v1, p0, Lcom/google/firebase/messaging/d;->mContext:Landroid/content/Context;
    ...
    iget-object v0, p0, Lcom/google/firebase/messaging/d;->bfY:Ljava/lang/reflect/Method;

    if-nez v0, :cond_6

    const-string v0, "setChannelId"

    invoke-static {v0}, Lcom/google/firebase/messaging/d;->dh(Ljava/lang/String;)Ljava/lang/reflect/Method;

    move-result-object v0

    iput-object v0, p0, Lcom/google/firebase/messaging/d;->bfY:Ljava/lang/reflect/Method;
...
.method static declared-synchronized ap(Landroid/content/Context;)Lcom/google/firebase/messaging/d;
    .locals 2
    ...
    :try_start_0
    sget-object v0, Lcom/google/firebase/messaging/d;->bfW:Lcom/google/firebase/messaging/d;
    ...
    sput-object v0, Lcom/google/firebase/messaging/d;->bfW:Lcom/google/firebase/messaging/d;
...
.method private static d(Landroid/os/Bundle;Ljava/lang/String;)[Ljava/lang/Object;
    ...
    :goto_0
    invoke-static {p0, v0}, Lcom/google/firebase/messaging/d;->c(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
...
.method private final de(I)Z
    ...
    :cond_1
    :try_start_0
    iget-object v2, p0, Lcom/google/firebase/messaging/d;->mContext:Landroid/content/Context;
...
.method private static dh(Ljava/lang/String;)Ljava/lang/reflect/Method;
    .locals 4
    .annotation build Landroid/annotation/TargetApi;
        value = 0x1a
    .end annotation
...
.method private final di(Ljava/lang/String;)Ljava/lang/Integer;
    .locals 4
    ...
    :cond_2
    invoke-direct {p0}, Lcom/google/firebase/messaging/d;->uZ()Landroid/os/Bundle;
...
.method private final dj(Ljava/lang/String;)Ljava/lang/String;
    .locals 8
    .annotation build Landroid/annotation/TargetApi;
        value = 0x1a
    .end annotation
    ...
    :cond_1
    iget-object v0, p0, Lcom/google/firebase/messaging/d;->mContext:Landroid/content/Context;
    ...
    :try_start_0
    iget-object v2, p0, Lcom/google/firebase/messaging/d;->bfZ:Ljava/lang/reflect/Method;
    ...
    iput-object v2, p0, Lcom/google/firebase/messaging/d;->bfZ:Ljava/lang/reflect/Method;
    ...
    iget-object v6, p0, Lcom/google/firebase/messaging/d;->mContext:Landroid/content/Context;
...
.method private final e(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/google/firebase/messaging/d;->mContext:Landroid/content/Context;
    ...
    :cond_4
    invoke-static {p1, p2}, Lcom/google/firebase/messaging/d;->d(Landroid/os/Bundle;Ljava/lang/String;)[Ljava/lang/Object;
...
.method private final s(Landroid/os/Bundle;)Landroid/app/PendingIntent;
    .locals 4
    ...
    iget-object v3, p0, Lcom/google/firebase/messaging/d;->mContext:Landroid/content/Context;
    ...
    invoke-static {v0}, Lcom/google/firebase/messaging/FirebaseMessagingService;->p(Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, Lcom/google/firebase/messaging/d;->bga:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method private final uZ()Landroid/os/Bundle;
    .locals 4

    iget-object v0, p0, Lcom/google/firebase/messaging/d;->bfX:Landroid/os/Bundle;
    ...
    iput-object v0, p0, Lcom/google/firebase/messaging/d;->bfX:Landroid/os/Bundle;
...
# virtual methods
.method final r(Landroid/os/Bundle;)Z
    .locals 11
    ...
    invoke-static {p1, v1}, Lcom/google/firebase/messaging/d;->c(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v0}, Lcom/google/firebase/messaging/d;->e(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v5, p0, Lcom/google/firebase/messaging/d;->mContext:Landroid/content/Context;
    ...
    invoke-direct {p0, v3}, Lcom/google/firebase/messaging/d;->de(I)Z
    ...
    invoke-direct {p0, v0}, Lcom/google/firebase/messaging/d;->di(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    :goto_3
    invoke-direct {p0, p1}, Lcom/google/firebase/messaging/d;->s(Landroid/os/Bundle;)Landroid/app/PendingIntent;

    move-result-object v6

    invoke-static {p1}, Lcom/google/firebase/messaging/FirebaseMessagingService;->q(Landroid/os/Bundle;)Z
    ...
    invoke-static {v0, p1}, Lcom/google/firebase/messaging/d;->a(Landroid/content/Intent;Landroid/os/Bundle;)V
    ...
    iget-object v7, p0, Lcom/google/firebase/messaging/d;->bga:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v7}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    move-result v7

    invoke-static {v6, v7, v0}, Lcom/google/firebase/iid/ac;->a(Landroid/content/Context;ILandroid/content/Intent;)Landroid/app/PendingIntent;
    ...
    iget-object v7, p0, Lcom/google/firebase/messaging/d;->mContext:Landroid/content/Context;

    iget-object v8, p0, Lcom/google/firebase/messaging/d;->bga:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v8}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    move-result v8

    invoke-static {v7, v8, v0}, Lcom/google/firebase/iid/ac;->a(Landroid/content/Context;ILandroid/content/Intent;)Landroid/app/PendingIntent;
    ...
    invoke-direct {p0, v0}, Lcom/google/firebase/messaging/d;->dj(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v8

    move-object v0, p0

    invoke-direct/range {v0 .. v8}, Lcom/google/firebase/messaging/d;->a(Ljava/lang/CharSequence;Ljava/lang/String;ILjava/lang/Integer;Landroid/net/Uri;Landroid/app/PendingIntent;Landroid/app/PendingIntent;Ljava/lang/String;)Landroid/app/Notification;
    ...
    invoke-direct {p0, v0}, Lcom/google/firebase/messaging/d;->de(I)Z
    ...
    iget-object v8, p0, Lcom/google/firebase/messaging/d;->mContext:Landroid/content/Context;
    ...
    invoke-direct {v0, v8, v10}, Landroid/support/v4/app/aa$c;-><init>(Landroid/content/Context;B)V

    invoke-virtual {v0}, Landroid/support/v4/app/aa$c;->cZ()Landroid/support/v4/app/aa$c;

    move-result-object v0

    invoke-virtual {v0, v3}, Landroid/support/v4/app/aa$c;->ad(I)Landroid/support/v4/app/aa$c;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/app/aa$c;->e(Ljava/lang/CharSequence;)Landroid/support/v4/app/aa$c;
    ...
    iput v1, v0, Landroid/support/v4/app/aa$c;->zT:I

    :cond_18
    if-eqz v5, :cond_19

    invoke-virtual {v0, v5}, Landroid/support/v4/app/aa$c;->e(Landroid/net/Uri;)Landroid/support/v4/app/aa$c;

    :cond_19
    if-eqz v6, :cond_1a

    iput-object v6, v0, Landroid/support/v4/app/aa$c;->zx:Landroid/app/PendingIntent;
